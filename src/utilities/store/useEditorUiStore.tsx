...
//   TextVariant,
//   Overlay,
// } from './useStudioStore'; // adjust path if needed

// type OverlaySize = { width: number; height: number };

// export type ActiveTool = 'timeline' | 'music' | 'text' | 'effects' | 'ml' | 'none' | 'ai' | 'export' | 'chat';
...
//   /** Playback state */
//   isPlaying: boolean;
//   currentTime: number;      // global project timeline seconds (for slider)
//   statusDuration: number;   // raw duration from Video status (seconds)
//   projectTime: number;      // if you want to keep this separate
//   projectDuration: number;  // total project length (seconds, for slider max)
...
//   pruneLiveOverlays: (olderThan: number) => void; // drop overlays that ended before this time
// };
